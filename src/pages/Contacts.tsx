...
const Contacts = () => {
  ...
  const handleSubmit = async () => {
    ...
    toast.promise(
      ...
      {
        loading: 'Отправляем ваш бриф в Telegram...',
        success: 'Спасибо! Ваш бриф успешно отправлен в Telegram. Мы свяжемся с вами в ближайшее время.',
        error: 'Произошла ошибка при отправке в Telegram. Пожалуйста, проверьте правильность введенных данных.'
      }
    );
  };
