...
const sections = [
  ...
  //   title: 'Тарифы',
  //   icon: DollarSign,
  //   description: 'Прозрачные цены от 15k ₽. Lite, Pro, Full — выберите свой вариант',
  //   link: '/pricing',
  //   highlights: ['Фиксированные цены', 'Без скрытых платежей', 'От 15k ₽'],
  // },
  {
    title: 'Процесс',
    icon: Workflow,
          ...
          <div className={cn(siteContainerClass, 'relative z-10 w-full')}>
            <div className="max-w-5xl">
              ...
              >
                ...
                Запуск обычно за 2–3 недели — от 8k ₽.
              </p>
